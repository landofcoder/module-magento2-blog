 ...
 */
namespace Ves\Blog\Block\Adminhtml\Importer;
...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    protected function _construct()
    {
        ...
        parent::_construct();
        if ($this->_isAllowedAction('Ves_Blog::importer_save')) {
        ...
        if ($this->_isAllowedAction('Ves_Blog::importer_delete')) {
    ...
    {
        if ($this->_coreRegistry->registry('current_importer')->getId()) {
            return __("Edit Importer '%1'", $this->escapeHtml($this->_coreRegistry->registry('current_importer')->getTitle()));
        } else {
    ...
    {
        return $this->getUrl('vesblog/*/save', ['_current' => true, 'back' => 'edit', 'active_tab' => '{{tab_id}}']);
    }
